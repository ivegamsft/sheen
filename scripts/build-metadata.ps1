...
$intents = @(
    ...
    [ordered]@{ intent = 'style-guide-authoring';  keywords = @('style-guide','document-guidelines','guide-authoring','offline-html-guide','guide-refresh','guide-freshness'); skill = 'style-guide-authoring'; agent = 'design-reviewer'; discriminator = 'brand-guide' }
    ...
    [ordered]@{ intent = 'app-component-catalog';  keywords = @('component-catalog','component-gallery','logical-component','reuse-extend-create'); skill = 'app-component-catalog'; agent = 'design-system-architect'; discriminator = 'component-spec' }
    ...
    [ordered]@{ intent = 'experience-blueprint-audit'; keywords = @('experience-blueprint','ux-audit','end-to-end-experience'); skill = 'experience-blueprint'; agent = 'experience-architect'; discriminator = 'audit-report' }
    [ordered]@{ intent = 'experience-blueprint-generate'; keywords = @('brief-to-blueprint','archetype-composition','experience-generate'); skill = 'experience-blueprint'; agent = 'experience-architect'; discriminator = 'concept-brief' }

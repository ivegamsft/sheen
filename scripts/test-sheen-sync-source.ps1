...
Write-Host '[1/4] standalone sync defaults use the public mirror'
...
Write-Host '[2/4] bootstrap-generated .sheen.yml defaults use the public mirror'
...
Write-Host '[3/4] scheduled sync template uses internal callable but public asset source'
...
Write-Host '[4/4] callable workflow falls back from private source to public mirror when no fetch token is provided'
